      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            To uphold integrity, promote innovation, and support our members in
            delivering top-tier surveying services to Nigeria and beyond.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative mb-8">
                  <div
                    className={`w-20 h-20 rounded-2xl ${mission.iconBg} flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg`}
                  >
                    <IconComponent
                      className={`w-10 h-10 bg-gradient-to-br ${mission.iconGradient} bg-clip-text text-transparent`}
                      stroke="url(#gradient)"
                      strokeWidth={2}
                    />
                  </div>
