          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-400 leading-relaxed mb-6 max-w-sm">
                Leading excellence in surveying across Nigeria since 1985. Committed to precision and professional development.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Home', 'About', 'Services', 'Members', 'Contact'].map((link) => (
                  <li key={link}>
                    <a 
        ...
        <div className="border-t border-slate-800 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-gray-500 text-sm">
              © {currentYear} Nigerian Association of Surveying Technologists. All rights reserved.
            </p>
            <div className="flex items-center space-x-6 text-sm">
              <a href="/privacy" className="text-gray-500 hover:text-emerald-400 transition-colors duration-200">
                Privacy
              </a>
              <a href="/terms" className="text-gray-500 hover:text-emerald-400 transition-colors duration-200">
                Terms
              </a>
            </div>
          </div>
